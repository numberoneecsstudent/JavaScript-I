...
let carModels = [];
const carModelGrabber = function(){
    for (let i=0; i<inventory.length; i++){
...
let carYears = [];
const carYearsGrabber = function ()
{
    for(let i=0; i < inventory.length; i++)
    {
...
console.log(oldCars);
console.log("We have a total of " + oldCars.length + " cars older than the year 2000!")
